...
<head>
    ...
    <title>GreenAgro - Forgot Password</title>
    ...
    <style>
        ...
        .input-field:focus {
            outline: none;
            border-color: #16a34a; /* Emerald 500 */
        ...
        <div class="pt-0 px-8 sm:px-12 lg:px-16 pb-8">
            <div class="max-w-md mx-auto">
                ...
                <form id="reset-form" class="space-y-6">
                    ...
                    <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-md text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-150 transform hover:scale-[1.01]">
                            Send Reset Link
                    </button>
                </form>
