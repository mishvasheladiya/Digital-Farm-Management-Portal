...
<head>
    ...
    <style>
        ...
        .main-container {
            max-width: 1200px;
            /* Max width for the entire card on desktop */
            height: auto;
            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="mt-6 text-center text-sm text-gray-500 border-t pt-4">
                    <p>Don't have an account?
                        <a href="<?php echo $base_url; ?>components/register.php" class="font-medium text-green-600 hover:text-green-500 transition">Sign up here</a>
                    </p>
                </div>
            </div>
        </div>
