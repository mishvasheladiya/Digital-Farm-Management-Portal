...
@media (max-width: 768px) {
    ...
    .step-item {
        flex-direction: column;            /* Arrange circle & label vertically */
        align-items: center;
        text-align: center;
        position: relative;
    }
    ...
    .step-label {
        margin: 6px 0 0 0;                 /* Label below the circle */
        font-size: 0.9rem;
    }
    ...
    .step-separator.completed {
        ...
        /* Step 4 success */
        .success-circle { width:80px; height:80px; border-radius:50%; background-color:#10b981; display:flex; align-items:center; justify-content:center; margin:auto; }
        .success-circle svg { width:40px; height:40px; color:white; }
    </style>
</head>
