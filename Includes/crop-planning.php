...
<head>
    ...
    <title>GreenAgro - Crop Planning</title>
...
<body>
    ...
    <section style="font-family: 'Poppins', sans-serif; padding: 70px 8%; background-color: #f9fafb;">
        <div style="text-align: center; margin-bottom: 50px;">
            <h2 style="color: #16a34a; font-size: 2rem; font-weight: 700;">Smart Planning for Better Yield</h2>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
            ...
            <div style="background: #fff; border-radius: 14px; box-shadow: 0 3px 10px rgba(0,0,0,0.08); overflow: hidden; transition: transform 0.3s;">
                <img src="<?php echo $base_url; ?>Assets/images/Operations/Seasonal.webp" alt="Seasonal Planning" style="width: 100%; height: 200px; object-fit: cover;">
            ...
            <!-- CARD 2 -->
            <div style="background: #fff; border-radius: 14px; box-shadow: 0 3px 10px rgba(0,0,0,0.08); overflow: hidden; transition: transform 0.3s;">
                <img src="<?php echo $base_url; ?>Assets/images/Operations/Seed.jpg" alt="Seed Selection" style="width: 100%; height: 200px; object-fit: cover;">
                <div style="padding: 25px;">
            ...
            <!-- CARD 3 -->
            <div style="background: #fff; border-radius: 14px; box-shadow: 0 3px 10px rgba(0,0,0,0.08); overflow: hidden; transition: transform 0.3s;">
                <img src="<?php echo $base_url; ?>assets/images/Operations/Resource.jpg" alt="Resource Allocation" style="width: 100%; height: 200px; object-fit: cover;">
                <div style="padding: 25px;">
    ...
    <!-- ✅ TIPS SECTION -->
    <section style="background-color: #1a4d2e69; color: white; padding: 60px 8%; text-align: center;">
        ...
        <a href="<?php echo $base_url; ?>Includes/crop-planning.php" style="background: #fff; color: #1A4D2E; padding: 12px 25px; border-radius: 8px; font-weight: 600; text-decoration: none;">
            Learn More
        </a>
    </section><br/><br/>
