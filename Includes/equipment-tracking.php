...
<head>
    ...
    <title>GreenAgro - Equipment Tracking</title>
...
<body>
    ...
    <section class="flex flex-col md:flex-row items-center justify-between p-10 md:p-20 bg-white rounded-2xl shadow-lg mx-auto mt-10 max-w-7xl">
        ...
        <div class="md:w-1/2 pr-0 md:pr-10">
            <h2 class="text-3xl font-bold mb-4" style="color: #16a34a;">Empowering GreenAgroers with Smart Tools</h2>
            <p class="text-gray-700 leading-relaxed mb-4">
                The GreenAgro Equipment Tracking system is designed to bring automation and efficiency
                to your GreenAgro operations. With real-time location tracking, maintenance reminders, and
            ...
            <p class="text-gray-700 leading-relaxed">
                ...
                decisions that boost your GreenAgro’s profitability.
            </p>
        </div>

        <!-- Right Image -->
        <div class="md:w-1/2 mt-8 md:mt-0">
            <img src="<?php echo $base_url; ?>assets/images/Operations/equipment-tracking.jpg"
                alt="GreenAgro Equipment Tracking"
    ...
    <section class="max-w-7xl mx-auto py-16 px-6">
        <h2 class="text-3xl font-bold text-center mb-10" style="color: #16a34a;">Key Features of Our Tracking System</h2>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">

            <div class="bg-white shadow-md rounded-2xl p-8 hover:shadow-xl transition">
                <img src="<?php echo $base_url; ?>assets/images/Operations/gps.jpg" alt="GPS Tracking" class="w-20 h-20 mx-auto mb-4">
                <h3 class="text-xl font-semibold mb-2 text-center" style="color: #16a34a;">Real-Time GPS Tracking</h3>
            ...
            <div class="bg-white shadow-md rounded-2xl p-8 hover:shadow-xl transition">
                <img src="<?php echo $base_url; ?>assets/images/Operations/maintenance.jpg" alt="Maintenance Alerts" class="w-20 h-20 mx-auto mb-4">
                <h3 class="text-xl font-semibold mb-2 text-center" style="color: #16a34a;">Maintenance Reminders</h3>
                <p class="text-gray-600 text-center">
            ...
            <div class="bg-white shadow-md rounded-2xl p-8 hover:shadow-xl transition">
                <img src="<?php echo $base_url; ?>assets/images/Operations/analytics.png" alt="Usage Analytics" class="w-20 h-20 mx-auto mb-4">
                <h3 class="text-xl font-semibold mb-2 text-center" style="color: #16a34a;">Usage Analytics</h3>
                <p class="text-gray-600 text-center">
                    Analyze performance data, fuel consumption, and efficiency to make smart GreenAgroing decisions.
                </p>
            </div>
        </div>
    </section>
